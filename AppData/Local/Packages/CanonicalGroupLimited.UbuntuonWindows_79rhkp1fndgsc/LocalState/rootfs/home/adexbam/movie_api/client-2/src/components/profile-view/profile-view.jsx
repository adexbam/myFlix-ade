...
export class ProfileView extends React.Component {
    ...
    handleSubmit(event) {
        ...
        axios.put(`https://myflix-ade.herokuapp.com/users/${localStorage.getItem('user')}`, {
    ...
    deleteMovie(event, favoriteMovie) {
        ...
        axios.delete(`https://myflix-ade.herokuapp.com/users/${localStorage.getItem('user')}/movies/${favoriteMovie}`, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}`}
        })
        .then(response => {
